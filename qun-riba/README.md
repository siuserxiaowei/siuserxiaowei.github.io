...
### English
WeChat group daily-report tool for chat summaries, community reviews, and AI report output.
...
- GitHub 仓库 / Repository: https://github.com/siuserxiaowei/qun-riba
- Live / 在线入口：https://siuserxiaowei.github.io/qun-riba
...
| `20260429` | 项目文件或目录。 | Project file or directory. |
| `20260502` | 项目文件或目录。 | Project file or directory. |
| `20260506` | 项目文件或目录。 | Project file or directory. |
| `20260520` | 项目文件或目录。 | Project file or directory. |
| `20260521` | 项目文件或目录。 | Project file or directory. |
| `20260522` | 项目文件或目录。 | Project file or directory. |
